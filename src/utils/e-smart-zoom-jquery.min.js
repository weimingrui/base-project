...
(function ($) {
	...
	$.fn.smartZoom = function (method) {
		...
		if (publicMethods[method]) { // if the parameter is an existing method, then we call this method
			...
			if (targetElement[0] && targetElement[0].tagName.toLowerCase() == "img" && !targetElement[0].complete) { // if the target is an image when wait for image loading before initialization
